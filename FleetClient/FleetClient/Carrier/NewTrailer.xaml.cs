...
namespace FleetClient
{
    ...
    public sealed partial class NewTrailer : Page
    {
        ...
        async Task RunAsync()
        {
            ...
            Trailer trailer = new Trailer { CarrierId = CarrierID, LicensePlate = license.Text, Make = make.Text, Vin = vinnum.Text, TrailerType = trailertype.Text, Year = year.Text, Model = model.Text };
