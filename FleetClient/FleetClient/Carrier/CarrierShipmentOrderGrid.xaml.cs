...
{
    public sealed partial class CarrierShipmentOrderGrid : UserControl
    {
        
        static HttpClient client = new HttpClient();
        public CarrierShipmentOrderGrid()
        {
            InitializeComponent();
        ...
        public async Task InitcarriershipmentOrdergrid(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                carriershipmentOrderdataGrid.ItemsSource = ShipmentOrders.Where(x=>x.CarrierId == id && x.DriverId == null);
                carriershipmentOrderdataGrid.UpdateLayout();
                return;
            }
            else
            {
        ...
        {
            carriershipmentOrderdataGrid.SelectedItems.Clear();
