...
namespace FleetClient
{
    ...
    public sealed partial class EditShipment : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Freighttype.SelectedIndex = findCombo(Freighttype, selectedshipment.FreightType);
            ...
            destDate.Date = selectedshipment.DestinationApptDatetime.Value.Date;
            oDate.Date = selectedshipment.OriginApptDatetime.Value.Date;
            destTime.Time = selectedshipment.DestinationApptDatetime.Value.TimeOfDay;
            oTime.Time = selectedshipment.OriginApptDatetime.Value.TimeOfDay;
            oProvince.SelectedIndex = findCombo(oProvince, selectedshipment.Origin.Address.Province);
            destProvince.SelectedIndex = findCombo(destProvince, selectedshipment.Destination.Address.Province);
        }
        ...
        async Task RunAsync()
        {
            ...
            Shipment shipment = new Shipment
            {
                ...
                Notes = "editted note for shipment",
        ...
        private int findCombo(ComboBox comboBox, string search)
        {
            int i = 0;
            foreach (var item in comboBox.Items)
            {
                if ((string)item == search.Trim())
                {
                    break;
                }
                else
