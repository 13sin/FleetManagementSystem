...
{
    public sealed partial class ShipmentOrderGrid : UserControl
    {
        
        static HttpClient client = new HttpClient();
        public ShipmentOrderGrid()
        {
            InitializeComponent();
        ...
        public async Task InitshipmentOrdergrid(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                shipmentOrderdataGrid.ItemsSource = ShipmentOrders.Where(x=>x.Shipment.BrokerId == id);
        ...
        async Task CancelAsync()
        {
            ...
            shipmentorder.Shipment.BrokerId = null;
