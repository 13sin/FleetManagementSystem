...
namespace FleetClient
{
    ...
    public sealed partial class NewTruck : Page
    {
        ...
        async Task RunAsync()
        {
            ...
            Truck truck = new Truck { Carrier=carrier, LicensePlate=license.Text, Make=make.Text, Vin=vinnum.Text, TruckType=trucktype.Text, Year=year.Text,Model=model.Text, Location=carrier.Address.City+", "+ carrier.Address.Province };
