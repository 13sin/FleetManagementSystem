...
namespace FleetClient
{
    ...
    /// </summary>
    public sealed partial class NewDriver : Page
    {
        ...
        private void DriverSave_Click(object sender, RoutedEventArgs e)
        {
            RunAsync().GetAwaiter();
        }
        async Task RunAsync()
        {
            ...
            response = await client.PostAsync("http://tamasdeep1624-eval-test.apigee.net/proxyfleetapi/api/Drivers", content);
            if (response.IsSuccessStatusCode)
            {
                success.Text = "Successfully Added Driver";
            }
