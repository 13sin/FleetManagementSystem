...
namespace AuthServer.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<AuthServerUser> signInManager, UserManager<AuthServerUser> userManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AuthServerUser user = await _userManager.FindByEmailAsync(Input.Email);
                IList<string> rolelist = await _userManager.GetRolesAsync(user);
                if(result.Succeeded && rolelist.Contains("admin") )
                {
